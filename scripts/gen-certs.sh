...
# tx-orchestrator (now orchestrator-tx), and any other internal partner). The output is
...
OUT="${1:-./certs}"
SERVICES="${SERVICES:-mpc-signer orchestrator-tx engine-policy-risk kyt-aml-screening accounting-ledger gateway-blockchain}"
DAYS="${DAYS:-3650}"
