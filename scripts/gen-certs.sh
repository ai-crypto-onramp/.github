...
# tx-orchestrator, and any other internal partner). The output is
...
OUT="${1:-./certs}"
SERVICES="${SERVICES:-mpc-signer tx-orchestrator policy-risk-engine kyt-aml-screening accounting-ledger gateway-blockchain}"
DAYS="${DAYS:-3650}"
